# Yacht collection audit 10 — independent QA

## Verdict

**Changes required. Do not release or publish the 20-yacht selection.**

The settled technical refresh is now internally synchronized: all 20 metrics files contain 842 rendered views, all 391 current paths are represented, all 370 quality screenshot paths and file hashes pass, and all 20 quality master and manifest hashes match.

The release remains blocked by conservative visual quality findings: rooms are still sparse/blockout assemblies, model-specific geometry and materials remain weak, the Superhawk `interior-main` LOD1 is byte-identical to LOD0, and no independent approval exists.
...
Exterior LOD1 is lighter for all 20 pairs. Interior LOD1 is lighter for 21/22 pairs; Superhawk `interior-main` remains unchanged at `3904 -> 3904` triangles and is byte-identical. This is the remaining known technical LOD blocker.
...
| ID | Components / rooms / decks | Current / metrics / quality-current | LOD exterior | Notes |
|---|---:|---:|---:|---|
| `princess-r35-gen1-2018` | 21 / 4 / 3 | 18 / 38 / 17 | 4736→2172 | Sparse rooms and generic geometry; no camera/luminance failure. |
| `princess-v40-gen2-2017` | 24 / 6 / 3 | 20 / 43 / 19 | 5176→2384 | Generic F/V-family blockout; no clipping confirmed. |
| `princess-v55-gen2-2019` | 34 / 10 / 3 | 25 / 71 / 23 | 17794→2672 | Blank evidence fixed; room/deck fidelity remains coarse. |
| `princess-f45-gen1-2019` | 23 / 5 / 3 | 19 / 55 / 18 | 6368→2716 | Open-plane rooms and generic family geometry. |
| `princess-f55-gen1-2017` | 24 / 6 / 3 | 20 / 43 / 19 | 6384→2716 | Sparse rooms and template exterior. |
| `princess-f65-gen1-2022` | 24 / 6 / 3 | 20 / 43 / 19 | 6384→2678 | Cabins and engine room remain blockouts. |
| `princess-y85-gen1-2019` | 24 / 6 / 3 | 20 / 43 / 19 | 6368→2668 | Y85 identity and room enclosure remain weak. |
| `princess-x95-gen1-2020` | 23 / 4 / 3 | 18 / 38 / 17 | 6760→2732 | Sparse rooms and scaled generic hull. |
| `princess-s65-gen1-2015` | 24 / 6 / 3 | 20 / 43 / 19 | 6376→2692 | S65-specific identity and supported detail remain weak. |
| `princess-s72-gen1-2014` | 24 / 6 / 3 | 20 / 43 / 19 | 6376→2674 | Incomplete room architecture. |
| `sunseeker-hawk-38-gen1-2018` | 20 / 2 / 3 | 16 / 32 / 15 | 5948→2702 | Generic sports-yacht identity. |
| `sunseeker-superhawk-55-gen1-2023` | 18 / 4 / 2 | 17 / 28 / 16 | 13200→7116 | Visible and luminance-clean; coarse rooms; interior-main LOD unchanged. |
| `sunseeker-portofino-48-gen1-2010` | 23 / 5 / 3 | 19 / 41 / 18 | 5616→2390 | Sparse rooms and generic Portofino treatment. |
| `sunseeker-predator-57-gen2-2017` | 24 / 6 / 3 | 20 / 34 / 19 | 5512→2380 | Prior clipping absent; sparse rooms and generic identity. |
| `sunseeker-predator-74-gen2-2018` | 25 / 6 / 3 | 20 / 43 / 19 | 6820→2778 | Weak room enclosure and model identity. |
| `sunseeker-predator-84-gen1-2008` | 25 / 6 / 3 | 20 / 43 / 19 | 6820→2784 | Guest rooms/day head remain slabs. |
| `sunseeker-manhattan-55-gen2-2021` | 24 / 6 / 3 | 20 / 43 / 19 | 6652→2720 | Sparse Manhattan detail. |
| `sunseeker-manhattan-63-gen1-2010` | 24 / 6 / 3 | 20 / 34 / 19 | 6652→2682 | Prior clipping absent; sparse rooms. |
| `sunseeker-manhattan-73-gen1-2012` | 24 / 6 / 3 | 20 / 43 / 19 | 6644→2686 | Weak model-specific treatment. |
| `sunseeker-90-ocean-gen1-2020` | 23 / 5 / 3 | 19 / 41 / 18 | 6584→2672 | Identity and completeness remain weak. |

## Required next gate

Complete model-specific geometry and room/material work, make V55 deck views genuinely deck-specific, produce a lighter Superhawk interior-main LOD, then repeat independent QA. Publication remains blocked until every selected ID passes the draft checks and receives explicit independent approval.

This audit created only `collection-audit-10.json` and `collection-audit-10.md`; it did not modify production assets or quality records. Earlier audits were preserved.
